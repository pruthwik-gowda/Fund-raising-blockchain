    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[20px]">
          ...
          {/* Campaign Story */}
          <div className="flex flex-col p-4 bg-[#1c1c24] rounded-[10px] shadow-secondary">
          <div>
            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? donators.map((item, index) => (
                <div key={`${item.donator}-${index}`} className="flex justify-between items-center">
                  <div className=" p-4 bg-[#13131a] rounded-[10px] overflow-hidden shadow-secondary">
                  <p className="font-epilogue font-normal text-[16px] text-[#b2b3bd] leading-[26px]  break-ll truncate"> <span>{item.donator} - {item.donation} ETH </span></p>
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col justify-around space-y-5 p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            {/* <div className="mt-[30px] flex flex-col justify-around space-y-5"> */}
              <input 
                ...
                placeholder="ETH 0.1"
                step="0.01"
                className="w-full py-[10px] sm:px-[20px] px-[15px] outline-none border-[1px] border-[#3a3a43] bg-transparent font-epilogue text-white text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[10px] shadow-secondary"
                value={amount}
              ...
              {isAmount ? <CustomButton 
                btnType="button"
                title="Fund Campaign"
                styles="w-full bg-[#8c6dfd] shadow-secondary"
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="flex flex-col justify-around space-y-5">
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px] flex justify-center shadow-secondary">
                {qrCodeURL ? (
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px] shadow-secondary">
